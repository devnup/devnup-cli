 ...
 *
 * @type {Function}
 * @alias com.devnup.cli.lib.email.recipientWrapper
 */
module.exports = {

  /**
   * @static
   * @alias com.devnup.cli.lib.email.recipientWrapper.list
   *
  ...
  /**
   * @static
   * @alias com.devnup.cli.lib.email.recipientWrapper.create
   * @param {Object} data The data object
   * @param {String} data.token The user access token
  ...
  /**
   * @static
   * @alias com.devnup.cli.lib.email.recipientWrapper.remove
   * @param {Object} data The data object
   * @param {String} data.token The user access token
