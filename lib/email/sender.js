 ...
 *
 * @type {Function}
 * @alias com.devnup.cli.lib.email.senderWrapper
 */
module.exports = {

  /**
   * @static
   * @alias com.devnup.cli.lib.email.senderWrapper.list
   *
  ...
  /**
   * @static
   * @alias com.devnup.cli.lib.email.senderWrapper.create
   * @param {Object} data The data object
   * @param {String} data.token The user access token
  ...
  /**
   * @static
   * @alias com.devnup.cli.lib.email.senderWrapper.remove
   * @param {Object} data The data object
   * @param {String} data.token The user access token
