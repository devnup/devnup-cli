 ...
 * @param {String} input.base_url The base url for the requests. Example: ```http://sample.devnup.com.br/api/```
 * @param {String} input.url The url for the requests. Example: ```users/login```
 *
 * @return {com.devnup.cli.lib.api.callback} The callback interface
 */
